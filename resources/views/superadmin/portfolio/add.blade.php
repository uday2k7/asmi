...
@section('content')
    ...
    <div class="card-body">
        ...
        <form id="create_campaign" action="{{url('cpanel/portfolio/store')}}" method="post" enctype="multipart/form-data" >
               <div class="offset-md-4 col-md-4 pt-5 pb-5" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="group_name"  name="group_name" class="form-control form-control-user" placeholder="Portfolio group Name">
                    </div>
                </div>
