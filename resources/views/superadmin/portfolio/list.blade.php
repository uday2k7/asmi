        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
                ...
                @endif
                 <h5 class="card-title">
                    <a class="btn btn-primary" href="{{ url('cpanel/portfolio/add') }}">Add Portfolio</a>
                </h5> 
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('cpanel/portfolio/details/'.$details['id']) }}" type="button" class="btn btn-outline-secondary"><i class="fas fa-tv"></i> View</button>
                      </td>
                    </tr>
                    @endforeach
