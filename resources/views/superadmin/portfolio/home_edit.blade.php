...
@section('content')
    <div class="card mb-4">
        <div class="card-body">
            <form class="row g-3" id="create_campaign" action="{{url('cpanel/banner/home/update')}}" method="post" enctype="multipart/form-data" >
                ...
                <div class="col-md-6">
                    <label for="content" class="form-label">Image(Upload 1920px X 1150px Image)</label>
