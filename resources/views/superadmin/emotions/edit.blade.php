...
<div class="card mb-4">
<div class="card-body">
<form class="row g-3" id="create_campaign" action="{{url('cpanel/emotions/update')}}" method="post" enctype="multipart/form-data" >
<input type="hidden" id="emotion_id"  name="emotion_id" value="{!! $data->id !!}">
                ...
                @if ($errors->any())
                    ...
                    @endif
<div class="col-md-6">
<label for="emotion_name" class="form-label">Name <i class="required">(*)</i></label>
<input type="text" id="emotion_name"  name="emotion_name" class="form-control" placeholder="Emotion Name" value="{!! $data->name !!}" >
</div>
<div class="col-md-6">
