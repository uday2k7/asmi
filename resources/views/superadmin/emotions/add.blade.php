...
@section('content')
    ...
    <div class="card-body">
        ...
        <form id="create_campaign" action="{{url('cpanel/emotions/store')}}" method="post" enctype="multipart/form-data" >
               <div class="offset-md-4 col-md-4 pt-5 pb-5" >
                    ...
                    <div class="form-group">
                        <label for="emotion_name">Name <span class="required">(*)</span></label>
                        <input type="text" id="emotion_name"  name="emotion_name" class="form-control form-control-user" placeholder="Emotion Name">
                    </div>
                    <div class="form-group">
