...
@section('content')
    <div class="row">
        <div class="col-6">
          <div class="card">
            <form action="{{url('cpanel/about/update')}}" method="post" enctype="multipart/form-data">
              ...
              @endif
              <div class="col-sm-9">
                <textarea class="form-control form-control-user" id="campaign_description" name="campaign_description" placeholder="About Us Content" rows="3">{!! $data->content !!}</textarea>
              </div>
              <div class="row">
