...
@section('content')
    ...
    <div class="card-body">
        ...
        <form id="create_campaign" action="{{url('cpanel/service/items-we-offered/details/update')}}" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="img_id" value="{{ $data['id'] }}">
