...
@section('content')
    ...
    <div class="card-body">
        ...
        <form id="create_campaign" action="{{url('cpanel/activities/store')}}" method="post" enctype="multipart/form-data" >
               <div class="offset-md-4 col-md-4 pt-5 pb-5" >
                    ...
                    <div class="form-group">
                        <label for="activitiy_name">Name <span class="required">(*)</span></label>
                        <input type="text" id="activitiy_name"  name="activitiy_name" class="form-control form-control-user" placeholder="Activitiy Name">
                    </div>
                    <div class="form-group">
